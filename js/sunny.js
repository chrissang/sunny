...
ko.components.register('upvoted-results', {
    ...
    template: `
        <div class="row upvotedResultsContainer">
            ...
            <!-- ko if: $parent.upVotedResults().length === 0 -->
                <h1>The items you like will get saved in a list that you can view right here. Handy, right?</h1>
            <!-- /ko -->
                    ...
                    <div class="small-10 columns small-centered">
                        <div class="row">
                            <div class="small-6 columns">
                                <a data-bind=""><img data-bind="attr: { src: $data.imageURL() }"></a>
                            </div>
...
ko.components.register('quickview', {
    ...
    template: `
        <div id="giftBotQuickViewModal" class="reveal-modal" data-reveal="" aria-hidden="true" role="dialog">
            <div class="row" style="max-width: 100%;">
                ...
                <div class="small-12 medium-6 text-center columns">
                    <div class="row">
                        ...
                        <div class="small-12 columns">
                            <div class="intro-text itemDescription" data-bind="text: $parent.viewModelTagLine()"></div>
                        </div>
                        <div class="small-12 columns">
                            <p class="item-price price">
    ...
    viewModel: class ProductsComponentModel extends Dependents {
        constructor(params) {
            ...
            this.upVote = function() {
                ...
                console.log('upvoteCounter ',this.params.parent.upvoteCounter());
...
ko.components.register('gift-bot-results-container', {
    viewModel: class GiftbotResultsComponentModel extends Dependents {
        constructor(params) {
            ...
            self = this;
            $.getJSON( "http://localhost:3000/js/coffee_search_results.json", function(data) {
    ...
    template: `
        <div class="giftBotResultsContainer">
                                ...
                                <div class="row">
                                    <div class="small-12 columns">
                                        ...
                                        <div class="right">
                                            ...
                                            <span class="signInIcon"><span class="icon-account icon-sm"></span><span>Hi, Microhyls</span></span>
                                            <span class="icon-caret_down icon-md"></span>
                                            <span class="icon-cart icon-md"></span><span>Checkout</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="right">
                                        <ul class="">
                                            <li>
                                                ...
                                                <div class="proTip">
                                                     <a data-bind="event: { click: viewSavedItems.bind($data) }"><label data-bind="text: toggleSavedText()"></label></a>
                                                     <!-- ko if: isProTip() -->
            ...
            <div id="giftBotResults" class="row fullwidth" data-bind="scroll, visible: displaySearchResultsToggle()">
                <div class="small-12 large-8 small-centered columns giftBotSearchResults">
