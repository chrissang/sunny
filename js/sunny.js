...
ko.components.register('gift-bot-results-container', {
    viewModel: (function (_super) {
        __extends(GiftbotResultsComponentModel, _super);
        function GiftbotResultsComponentModel(params) {
            _super.call(this, params);
