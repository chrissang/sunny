...
ko.components.register('products', {
    ...
    template: `
        <article class="product" data-bind="attr: { id: itemId() }">
            ...
            <div data-bind="attr: { class: displayUpVoteSelected() ? 'copy borderAdded upvoted moreLikeThis' : displayDownVoteSelected() ? 'copy borderAdded downvoted moreLikeThis' : 'copy moreLikeThis' }">
                <button data-bind="event:{ click: upVote.bind($data) }" class="btn-secondary">more like this</button>
                <h4>
...
ko.components.register('sunny-results-container', {
                    ...
                    function likeMoreItems() {
                        ...
                        $(document).ready(function() {
                            if (!self.isLikeMoreItemsCopy()) {
                                $("<p class='call-out-large'>").text('For more ideas, click "more like this"').appendTo("#likeMoreIdeas");
    ...
    template: `
        <div class="sunnyResultsContainer">
            ...
            <!-- Search Results -->
            <div class="sunnySearchResults" class="row fullwidth" data-bind="scroll, visible: displaySearchResultsToggle()">
